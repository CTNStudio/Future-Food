...
public class DatagenI18ZhCn extends LanguageProvider {
  ...
  protected void addTranslations() {
    ...
    addFood(ModItem.ANTIMATTER_SNACK, "反物质小吃", "一种非常美味的小吃，能量密度极高。如果你一口没有吃饱，那么可能会在你的胃里膨胀。");
    addFood(ModItem.STRONGLY_INTERACTING_BREAD, "强相互作用面包", "在你吃面包的时候，面包也在吃你。");
    addFood(ModItem.WEAKLY_INTERACTING_WATER_BOTTLE, "弱相互作用水瓶", "喝下它，你会感觉到一种从未有过的清凉感。但是你真的在喝吗？");
    addFood(ModItem.LEYDEN_JAR, "莱顿瓶", "一种古老的电学实验器材，里面装满了电。或许不应该用来吃。");
    ...
    addFood(ModItem.ENTROPY_STEW, "增熵炖菜", "吃下它，你会感觉到一种从未有过的混乱感。");
