    ...
    ClientViewGroup.tooltip(
      tooltip, groups, true, (theTooltip, group) -> {
        ...
        for (var view : group.views) {
          IWailaConfig.HandlerDisplayStyle style =
            config.getEnum(JadeIds.UNIVERSAL_ENERGY_STORAGE_STYLE);
          Component text;
          ...
          switch (style) {
            ...
            case PROGRESS_BAR -> {
              ...
              theTooltip.add(helper.progress(view.ratio, text, progressStyle,
