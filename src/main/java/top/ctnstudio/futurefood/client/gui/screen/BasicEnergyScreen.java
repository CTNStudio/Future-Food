...
public abstract class BasicEnergyScreen<T extends BasicEnergyMenu> extends AbstractContainerScreen<T> {
  private final ResourceLocation textureBg;
  protected EnergyBar energyBar;

  public BasicEnergyScreen(T menu, Inventory playerInventory, Component title, ResourceLocation textureBg) {
